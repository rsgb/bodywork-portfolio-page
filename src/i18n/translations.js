...
export const translations = {
  de: {
    ...
    support: {
      ...
      intro:
        "Menschen kommen aus unterschiedlichen Gründen zu einer Sitzung. Zum Beispiel:",
    ...
    pricing: {
      ...
      footnote:
        "Wenn die Kosten gerade ein Hindernis sind, melde Dich gern trotzdem.",
      items: [
    ...
    contact: {
      ...
      formSuccess: "Danke — deine Nachricht ist angekommen.",
      formError:
        "Das hat leider nicht geklappt. Bitte versuche es später erneut oder schreib mir auf WhatsApp.",
      formHoneypotLabel: "Nicht ausfüllen",
    },
    footer: {
      name: "Elias Krause",
      tag: "Rebalancing",
    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "Wenn Sie diese Website besuchen, werden durch Ihren Browser technisch notwendige Informationen an den Server übermittelt (z. B. Browsertyp, Datum und Uhrzeit der Anfrage). Die Website wird über Netlify bereitgestellt; der Anbieter kann Zugriffs- bzw. Server-Logdaten verarbeiten, die zur sicheren und stabilen Bereitstellung der Seite erforderlich sind. Weitere Hinweise: https://www.netlify.com/privacy/ Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an einer funktionsfähigen Website). Die Speicherdauer der Server-Logdaten richtet sich nach den Vorgaben des Anbieters.",
          },
          {
      ...
      imprint: {
        ...
        contactIntro:
          "Zur Kontaktaufnahme können Sie das Kontaktformular auf der Startseite, die unten angegebene Telefonnummer oder WhatsApp nutzen. Aus Gründen des Spam-Schutzes wird keine E-Mail-Adresse öffentlich angezeigt.",
        sections: [
          {
  ...
  en: {
    ...
    support: {
      ...
      intro:
        "People come to a session for many different reasons. For example:",
    ...
    pricing: {
      ...
      footnote:
        "If the cost is currently a barrier, feel free to reach out anyway.",
      items: [
    ...
    series: {
      ...
      sessions: [
        ...
        {
          title: "4. Pelvis",
          body: "Control and surrender, carrying and being carried.",
        },
        {
          title: "5. Belly",
    ...
    contact: {
      ...
      formSubmit: "Send",
      formSending: "Sending…",
      formSuccess: "Thank you — your message was received.",
      formError:
        "Something went wrong. Please try again later or message me on WhatsApp.",
      formHoneypotLabel: "Do not fill in",
    },
    footer: {
      name: "Elias Krause",
      tag: "Rebalancing",
    ...
    legal: {
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "When you visit the site, your browser automatically sends technically necessary information to the server (for example browser type, time of the request). This site is hosted on Netlify, which may process access or server log data as needed to deliver the site securely and reliably. Further information: https://www.netlify.com/privacy/ Legal basis: Art. 6(1)(f) GDPR (legitimate interest in a functioning website). The retention period for server log data follows the provider’s policies.",
          },
          {
            title: "3. Google Fonts",
      ...
      imprint: {
        ...
        contactIntro:
          "You can reach us using the contact form on the home page, the phone number below, or WhatsApp. For spam protection, no email address is shown publicly on this website.",
        sections: [
          {
